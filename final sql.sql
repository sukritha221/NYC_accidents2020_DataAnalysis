...
-- Null records in the `zip code` column can be filled by reffering to the `latitude`, `longitude` and `location` columns.
...
-- A python script is used to fetch these details and imported it to MySQL.
